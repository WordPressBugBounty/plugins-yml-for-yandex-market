...
class YFYM_Get_Unit_Offer_Simple extends YFYM_Get_Unit_Offer {
	...
	use YFYM_T_Simple_Get_Additional_Expenses;
	use YFYM_T_Simple_Get_Adult;
	use YFYM_T_Simple_Get_Age;
	use YFYM_T_Simple_Get_Amount;
	use YFYM_T_Simple_Get_Archived;
	use YFYM_T_Simple_Get_Barcode;
	use YFYM_T_Simple_Get_Cargo_Types;
	use YFYM_T_Simple_Get_CategoryId;
	use YFYM_T_Simple_Get_Cofinance_Price;
	use YFYM_T_Simple_Get_CollectionId;
	use YFYM_T_Simple_Get_Condition;
	use YFYM_T_Simple_Get_Consists;
	...
	use YFYM_T_Simple_Get_Custom_Labels;
	use YFYM_T_Simple_Get_Custom_Score;
	...
	use YFYM_T_Simple_Get_Market_Category;
	use YFYM_T_Simple_Get_Market_Category_Id;
	...
	use YFYM_T_Simple_Get_Purchase_Price;
	use YFYM_T_Simple_Get_Qty;
	use YFYM_T_Simple_Get_Recommend_Stock_Data;
	use YFYM_T_Simple_Get_Sales_Notes;
	use YFYM_T_Simple_Get_Shipment_Options;
	...
	use YFYM_T_Simple_Get_Type_Prefix;
	...
	use YFYM_T_Simple_Warranty_Days;
