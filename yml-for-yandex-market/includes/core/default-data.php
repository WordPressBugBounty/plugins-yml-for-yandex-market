 ...
 *
 * This file defines the complete structure of the plugin's default settings,
 * including option names, default values, field types, visibility, and tab assignments.
 * Used by the YML for Yandex Market plugin through the Y4YM_Data class to initialize 
 * and manage plugin settings.
 *
 * The array `$data_arr` contains all public and private options, grouped logically
 * into tabs for the admin interface. Private options are used internally (e.g., status,
...
$data_arr = [
	...
	[
		...
		'data' => [
			...
			'tag_name' => 'tn_ved_codes',
			'tag_name_for_desc' => 'tn-ved-codes'
		]
	],
	[
		'opt_name' => 'y4ym_okpd2',
	...
	[
		...
		'data' => [
			'has_next' => true,
			'table_location' => 'th-td',
			'label' => __( 'Brand', 'yml-for-yandex-market' ),
			'desc' => __( 'Brand', 'yml-for-yandex-market' ),
			'woo_attr' => true,
			'default_value' => true,
			'key_value_arr' => $vendor_souce_arr,
			'tag_name' => 'brand'
	...
	[
		...
		'data' => [
			...
			'woo_attr' => false,
			'default_value' => false,
			'key_value_arr' => $registered_image_sizes,
			'tag_name' => 'picture',
	...
	[
		...
		'data' => [
			'has_next' => true,
			'table_location' => 'th-td',
			'label' => __( 'Short description of the product', 'yml-for-yandex-market' ),
			'desc' => sprintf( '%s',
				__( 'The source of the short description', 'yml-for-yandex-market' )
			),
			'woo_attr' => false,
			'key_value_arr' => [
				[ 'value' => 'disabled', 'text' => __( 'Disabled', 'yml-for-yandex-market' ) ],
	...
	[
		'opt_name' => 'y4ym_source_shortdescription_post_meta',
		'def_val' => '',
		'mark' => 'public',
		'type' => 'text',
		'tab' => 'offer_data_tab',
	...
	[
		'opt_name' => 'y4ym_var_shortdescription_priority',
		'def_val' => 'disabled',
		'mark' => 'public',
		'type' => 'select',
		'tab' => 'offer_data_tab',
