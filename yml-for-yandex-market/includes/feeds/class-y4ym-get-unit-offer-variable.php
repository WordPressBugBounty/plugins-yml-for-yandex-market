...
class Y4YM_Get_Unit_Offer_Variable extends Y4YM_Get_Unit_Offer {
	...
	use Y4YM_T_Variable_Get_Compliance_Document_Type;
	...
	use Y4YM_T_Variable_Get_Ctru_Code;
	...
	use Y4YM_T_Variable_Get_Shortdescription;
